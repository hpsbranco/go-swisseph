...
- Include the speed calculations on `HousesEx2` and `HousesArmcEx2` return type
...
[1.0.0]: https://github.com/hpsbranco/go-swisseph/releases/tag/v1.0.0
[2.0.0]: https://github.com/hpsbranco/go-swisseph/releases/tag/v2.0.0
